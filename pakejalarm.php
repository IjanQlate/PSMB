...
<head>
  <meta charset="utf-8">
  <title>Pakej Alarm System</title>
  ...
  <div id="pricing" class="pricing-area area-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h2></br>Pakej Alarm System</h2>
			<ul class="nav navbar-nav navbar-right">
			<a href="spekalarm.php"><img src="img/spekicon.png" height="200" width="200" alt="" title=""></a>
          </div>
        </div>
      </div>
      <div class="row">
     ...
     width: 30%; padding: 10px ">
		  ...
		  <img src="img/blog/alarm4.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 2350 </h4>
            
            <ol>
              <li class="check">1x SP4000 4-Zone Main Panel</li>
              <li class="check">1x Plastic Housing</li>
              <li class="check">1x 10-zone LED Keypad</li>
              <li class="check">1x GPower 7.2Ah SLA Backup Battery</li>
			  <li class="check">1x 16VAC Transformer</li>
			  <li class="check">5x Vibration Sensor</li>
			   <li class="check">3x Magnetic Sensor</li>
			   <li class="check">1x Siren Box,Siren Horn & Strobe Light </li>
     ...
     width: 30%; padding: 10px ">
		  ...
		  <img src="img/blog/alarm8.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 3250 </h4>
            <ol>
              <li class="check">1x SP4000 8-Zone Main Panel</li>
              <li class="check">1x Plastic Housing</li>
              <li class="check">1x 10-zone LED Keypad</li>
              <li class="check">1x GPower 7.2Ah SLA Backup Battery</li>
			  <li class="check">1x 16VAC Transformer</li>
			  <li class="check">10x Vibration Sensor</li>
			   <li class="check">5x Magnetic Sensor</li>
			   <li class="check">1x Siren Box,Siren Horn & Strobe Light </li>
			   <li class="check">Jaminan selama <b>1 TAHUN</b></li>
              <li ><b>Standard Wiring and Installation</b></li>
            </ol>
