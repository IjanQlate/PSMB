    ...
    <div class="container">
      ...
      <div class="row text-center">
        <div class="services-contents">
          <!-- Start Left services -->
          <div class="col-md-12 col-sm-4 col-xs-12" style="background-color:white;">
          ...
          <div class="col-md-6 col-sm-4 col-xs-12" style="background-color:white;">
            <div class="about-move">
              <div class="services-details">
                <div class="single-services">

				<p></br></br></br></p>
                  <a class="services-icon" href="cnewcust.php">
          ...
          <div class="col-md-6 col-sm-4 col-xs-12" style="background-color:white;">
            ...
            <div class=" about-move">
              <div class="services-details">
                <div class="single-services">
				<p></br></br></br></p>
                  <a class="services-icon" href="csearch.php" >
											<i class="fa fa-bar-chart"></i>
										</a>
                  <h4>Search Customer Details</br></br></br></br></br></h4>
          ...
          <div class="col-md-8 col-sm-4 col-xs-12" style="background-color:white;">
            <!-- end col-md-4 -->
