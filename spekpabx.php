  ...
  <div id="pricing" class="pricing-area area-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
           <ul class="nav navbar-nav navbar-right">
			...
			<a href="pakejpabx.php"><img src="img/back2.png" height="100" width="100" alt="" title=""></a>
        </div>
      </div>
     ...
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek9.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
		  <div class="col-md-4 col-sm-4 col-xs-12" style=" 70%;
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek10.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
