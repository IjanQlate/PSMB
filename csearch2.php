...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `enq2` WHERE CONCAT('name','email','pno','adr','cty','st','pos','itn','quan') LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `enq2`";
    $search_result = filterTable($query);
...
?>
<?php
$query = "SELECT * from enq2 where id='".$id."'";
$connect = mysqli_connect("localhost", "root", "", "dashboardg"); 
    ...
    aria-label="Nama Pelanggan" style="margin-left: 1% ; text-align: center">
      ...
      <table class="table table-hover table-fixed .table-cell" id ="myTable" style="text-align: left">
                ...
                <tr class="table-dark text-dark" style="text-align: center ; background-color: lightgrey">
                    ...
                    <th style="text-align: center">Jenis Premis</th>
                    <th style="text-align: center">Lawatan Tapak?</th>
      ...
      <!-- populate table from mysql database -->
         ...
         <td>
                    <a button type="button" class="btn btn-danger" href="delete2.php?id=<?php echo $row["id"]; ?>" 
...
function delete_id(id)
{
     ...
     {
        window.location.href='csearch2.php?delete_id='+id;
     }
}
</script>
