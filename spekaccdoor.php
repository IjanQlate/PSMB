          ...
          <div class="col-md-12 col-sm-12">
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  <li class="active">
                    <a class="page-scroll" href="index.html#home">Laman Utama</a>
                  </li>
                  <li>
                    <a class="page-scroll" href="index.html#about">Siapa Kami</a>
                  </li>
                  <li>
                    <a class="page-scroll" href="index.html#services">Mengapa Kami</a>
                  </li>
                  <li>
				  <a class="page-scroll" href="index.html#portfolio">Testimoni</a>
                  ...
                  <li>
                    <a class="page-scroll" href="index.html#contact">Hubungi Kami</a>
                  </li>
				  <li>
				  </br>
                    <img src="img/login.png" height="50" width="50" alt="" title=""></a>
  ...
  <div id="pricing" class="pricing-area area-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
           <ul class="nav navbar-nav navbar-right">
			...
			<a href="pakejaccdoor.php"><img src="img/back2.png" height="100" width="100" alt="" title=""></a>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12" style=" 70%;
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek3.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
		  <div class="col-md-4 col-sm-4 col-xs-12" style=" 70%;
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek4.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
		  <div class="col-md-4 col-sm-4 col-xs-12" style=" 70%;
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek5.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
		    <div class="col-md-4 col-sm-4 col-xs-12" style=" 70%;
     width: 100%; padding: 10px ">
          <center>
		  <img src="img/about/spek6.jpg" height="800" width="800" alt="" title="">
		  </center>
          </div>
        </div>
