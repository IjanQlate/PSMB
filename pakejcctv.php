    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h2></br>Pakej CCTV</h2>
			<ul class="nav navbar-nav navbar-right">
			<a href="spekcctv.php"><img src="img/spekicon.png" height="200" width="200" alt="" title=""></a>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-12">
		  ...
		  <img src="img/blog/4CH.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 1800 </h4>
            
            <ol>
              <li class="check">1x Unit Decoder HD CVI 1080P</li>
              <li class="check">4x Unit Camera 2MP</li>
              <li class="check">1x Power Supply</li>
              <li class="check">1x 1TB Hardisk Western Digital</li>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
		  ...
		  <img src="img/blog/8CH.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 2950 </h4>
            <ol>
              <li class="check">1x Unit Decoder HD CVI 1080P</li>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
		  ...
		  <img src="img/blog/16CH.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 4300  </h4>
            <ol>
            <li class="check">1x Unit Decoder HD CVI 1080P</li>
              <li class="check">16x Unit Camera 2MP</li>
              <li class="check">1x Power Supply</li>
              <li class="check">1x 3TB Hardisk Western Digital</li>
              <li class="check">1x Wifi Dongle</li>
			   <li class="check">Jaminan selama <b>2 TAHUN</b></li>
              <li ><b>Standard Wiring and Installation</b></li>
            </ol>
