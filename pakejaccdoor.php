        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
		 <div class="col-md-12 col-sm-12 col-xs-12" style="background-color:white; ">
          <div class="section-headline text-center">
            <h2></br>Pakej Access Door</h2>
			<ul class="nav navbar-nav navbar-right">
			<a href="spekaccdoor.php"><img src="img/spekicon.png" height="200" width="200" alt="" title=""></a>
          </div>
        </div>
      </div>
       <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-12" style="left: 20%;
     width: 30%; padding: 10px ">
          <div class="pri_table_list">
		  </br>
		  <img src="img/blog/accessdoor.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 550 </h4>
            
            <ol>
              <li class="check">1x Standalone Door Access Controller</li>
              <li class="check">1x EM Lock 600lbs w/Single colour LED</li>
              <li class="check">1x Door Push Button</li>
              <li class="check">1x 12V 5A Switching Power Supply</li>
              <li class="check">1x GPower 12V 7.2Ah Backup Battery</li>
			  <li class="check">10x EM Proximity cards</li>
			   <li class="check">Jaminan selama <b>1 TAHUN</b></li>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12" style="background-color:;right: -20%;
     width: 30%; padding: 10px; ">
          <div class="pri_table_list active">
            <span class="saleon">top sale</span>
           </br>
		  <img src="img/blog/fingerprint.jpg" height="30" width="300" alt="" title="">
		  <h4> RM 1750 </h4>
            <ol>
              <li class="check">1x F21(Lite) Fingerprint Attendance </li>
               <li class="check">1x EM Lock 600lbs w/Single colour LED</li>
              <li class="check">1x Door Push Button</li>
              <li class="check">1x 12V 5A Switching Power Supply</li>
              <li class="check">1x GPower 12V 7.2Ah Backup Battery</li>
			  <li class="check">10x HID Compatible Card</li>
			   <li class="check">Jaminan selama <b>1 TAHUN</b></li>
              <li ><b>Standard Wiring and Installation</b></li>
            </ol>
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Beli</button>
